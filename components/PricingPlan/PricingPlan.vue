    ...
    <v-container :class="{ fixed: isDesktop }">
      ...
      <div class="pricing-wrap">
        ...
        <div class="col-lg-10 offset-lg-1 col-md-12">
            ...
            <div class="releases">
              <v-btn class="mx-2 my-2" dark large color="btn-cta" href="https://github.com/Livepool-io/transcoder/releases/download/v0.5.18/livepool-linux-amd64.tar.gz" target="_blank">
              ...
              <v-btn class="mx-2 my-2" dark large color="btn-cta" href="https://github.com/Livepool-io/transcoder/releases/download/v0.5.18/livepool-windows-amd64.zip" target="_blank">
