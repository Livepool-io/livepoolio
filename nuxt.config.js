  ...
  */
  head: {
    ...
    meta: [
      ...
      // Facebook
      { property: 'author', content: 'Livepool' },
      { property: 'og:site_name', content: 'livepool.io' },
      { property: 'og:locale', content: 'en_US' },
      { property: 'og:type', content: 'website' },
      // Twitter
      { property: 'twitter:site', content: 'livepool.io' },
      { property: 'twitter:domain', content: 'livepool.io' },
      { property: 'twitter:creator', content: 'Livepool' },
      { property: 'twitter:card', content: 'Earn ETH with your video cards' },
