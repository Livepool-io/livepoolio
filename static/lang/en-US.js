  ...
  return new Promise(function(resolve) {
    resolve({
      ...
      saasLanding: {
        ...
        feature_desc1:
          'Anyone can connect their Video Cards to Livepool to transcode video and earn passive income for doing so.',
        ...
        testi_content:
          "Staking your Livepeer Tokens (LPT) to Livepool has several benefits: you earn inflationairy LPT rewards, you earn a share of Livepool's transcoding rewards in ETH and you help the pool win more work. <br /><br/> To stake your Livepeer tokens go to the Livepeer Explorer",
        pricing_title: 'Get Started',
        pricing_subtitle:
          'Set up a Transcoder and connect to Livepool in minutes',
        faq_subtitle:
